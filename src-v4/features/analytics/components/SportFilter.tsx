...
export function SportFilter({ value, onChange }: SportFilterProps) {
  return (
    <select
      ...
      className="rounded-lg bg-void-surface/50 border border-edge-default px-3 py-1.5 text-xs font-medium text-text-dim appearance-none cursor-pointer hover:border-text-faint transition-colors focus:outline-none focus:ring-1 focus:ring-accent/40 pr-7"
      style={{
